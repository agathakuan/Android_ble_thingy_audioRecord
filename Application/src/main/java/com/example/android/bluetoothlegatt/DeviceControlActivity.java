...
public class DeviceControlActivity extends Activity {
    ...
    private Button mTransWav_bt;
    private TextView mRecordInfo;
    private TextView mMicStreamInfo;
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                displayData_pcm(intent.getStringExtra(BluetoothLeService.EXTRA_DATA));
            }else if(BluetoothLeService.ACTION_FINISH_WAV.equals(action)){
                Log.i(TAG,"recv at:"+intent.getStringExtra(BluetoothLeService.EXTRA_DATA));
                mRecordInfo.setText("save at:"+intent.getStringExtra(BluetoothLeService.EXTRA_DATA));
            }else if(BluetoothLeService.ACTION_RECV_MIC_STREAM.equals(action)){
                mMicStreamInfo.setText(intent.getStringExtra(BluetoothLeService.EXTRA_DATA));
            }
        }
    };
                ...
                public boolean onChildClick(ExpandableListView parent, View v, int groupPosition,
                    ...
                    if (mGattCharacteristics != null) {
                        ...
                        if ((charaProp | BluetoothGattCharacteristic.PROPERTY_NOTIFY) > 0) {
                            ...
                            mBluetoothLeService.setCharacteristicNotification(
                                    characteristic, true);
                            Log.i(TAG,"NOTIFY "+characteristic.getUuid());
                        }
                        return true;
                    }
                    return false;
    ...
    private void displayData_pcm(String pcm)
    {
        if (pcm != null){
            Log.i(TAG,"Devicecontrol 收到"+pcm.length());
            mRecordInfo.setText("YES..");
    ...
    private static IntentFilter makeGattUpdateIntentFilter() {
        ...
        intentFilter.addAction(BluetoothLeService.ACTION_FINISH_WAV);
        intentFilter.addAction(BluetoothLeService.ACTION_RECV_MIC_STREAM);
        return intentFilter;
    }
}
